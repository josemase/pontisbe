...
router.get('/profile/:id', async (req, res) => {
    ...
    async function getItem() {
        try {
            ...
            const profileWithSignedUrls = async (profile) => {
...
router.put('/profile/images/:uid/:id', upload.fields([{ name: 'images', maxCount: 6 }]), async (req, res) => {
...
router.delete('/profile/image/:uid/:id/:index', async (req, res) => {
